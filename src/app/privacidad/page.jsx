    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        <p className={styles.text}>
          ...
          al momento de utilizar nuestra Aplicación. Esta compañía se encuentra
          comprometida con la seguridad de los datos de sus usuarios. Cuando le
          solicitamos rellenar los campos de información, lo hacemos asegurando
          que sólo se emplearán los mismos de acuerdo con los términos de este
      ...
      <div className={styles.container}>
        ...
        <p className={styles.text}>
          ...
          correo electrónico, o ubicación. Así mismo cuando sea necesario podrá
          ser requerida información específica para procesar algún pedido o
      ...
      <div className={styles.container}>
        ...
        <p className={styles.text}>
          Nuestro Aplicación emplea la información con el fin de nutrir y dejar
          registro de las tareas que usted realizó en nuestro servidor para ser
          utilizados por empresas a la cual usted pertenece. Es posible que sean
          enviados correos electrónicos periódicamente a través de nuestro sitio
          con resúmenes de las tareas realizadas.
        </p>
      </div>
      <div className={styles.container}>
        <p className={styles.text}>
